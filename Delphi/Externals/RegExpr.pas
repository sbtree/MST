...
{$ENDIF}
{$UNDEF reRealExceptionAddr} // exceptions will point to appropriate source line, not to Error procedure
                             // GSV: Compilerschalter ausgeschaltet, weil sonst Assembler-Quellcode benutzt wird! 
