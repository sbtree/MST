...
//  ~~~~~~~~~~~~
//
//	- Init(unsigned short BTR0BTR1, int CANMsgType)  
//  - Close()  
//  - Status() 
//  - Write(TPCANMsg %msg) 
...
//  - SpecialFunktion(unsigned int distributorcode, unsigned int codenumber)
//  - ResetClient()
		...
		namespace Light
		{
			public ref class PCAN_PCC
			{
				public:
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_Init")]
					static unsigned int Init(unsigned short BTR0BTR1, int CANMsgType);
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_Close")]
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_Status")]
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_Write")]
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_Read")]
					...
					//  Possible Errors: NOVXD  QRCVEMPTY
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_ReadEx")]
					...
					//  Possible Errors:  NOVXD
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_VersionInfo")]
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint="CAN_DLLVersionInfo")]
					...
					//  Possible Errors:  NOVXD
					//
					[DllImport("PCAN_PCC.dll", EntryPoint = "CAN_SpecialFunktion")]
					static unsigned int SpecialFunktion(unsigned int distributorcode, unsigned int codenumber);
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint = "CAN_ResetClient")]
					...
					//
					[DllImport("PCAN_PCC.dll", EntryPoint = "CAN_MsgFilter")]
					...
					//  Possible Errors: NOVXD
					//
					[DllImport("PCAN_PCC.dll", EntryPoint = "CAN_ResetFilter")]
					...
					//
					[DllImport("PCAN_PCC.DLL", EntryPoint="CAN_SetRcvEvent")]
