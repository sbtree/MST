...
//  ~~~~~~~~~~~~
//
//  - CAN2_Init(wBTR0BTR1: Word; CANMsgType: Integer)
//  - CAN2_Close()
//  - CAN2_Status()
//  - CAN2_Write(var MsgBuff: TPCANMsg)
//  - CAN2_Read(var MsgBuff: TPCANMsg)
//  - CAN2_ReadEx(var MsgBuff: TPCANMsg; var RcvTime: TPCANTimestamp)
//  - CAN2_VersionInfo(lpszTextBuff: PChar)
//  - CAN2_DLLVersionInfo(LlpszTextBuff: PChar)
//  - CAN2_SpecialFunktion(distributorcode: LongWord; codenumber: Integer        
//  - CAN2_ResetClient()
//  - CAN2_MsgFilter(FromID, ToID: LongWord; _Type: Integer)
//  - CAN2_ResetFilter()
//	- SetUSB2DeviceNr(DevNum: LongWord)
//	- GetUSB2DeviceNr(var DevNum: LongWord)
//  - CAN2_SetRcvFunc(hEvent: THandle)
//
//  ------------------------------------------------------------------
...
//
function SetUSB2DeviceNr(DevNum: LongWord): LongWord; stdcall;
...
//
function GetUSB2DeviceNr(var DevNum: LongWord): LongWord; stdcall;
...
const DLL_Name = 'PCAN_2USB.dll';

function CAN2_Init(wBTR0BTR1: Word; CANMsgType: Integer): LongWord; stdcall;
external DLL_Name;
...
function CAN2_VersionInfo(lpszTextBuff: PChar): LongWord; stdcall;
external DLL_Name;

function CAN2_DLLVersionInfo(lpszTextBuff: PChar): LongWord; stdcall;
external DLL_Name;

function CAN2_SpecialFunktion(distributorcode: LongWord; codenumber: Integer): LongWord; stdcall;
external DLL_Name;
