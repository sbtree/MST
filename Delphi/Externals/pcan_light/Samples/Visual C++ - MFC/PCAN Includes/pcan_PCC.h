...
//  - CAN_SpecialFunktion(unsigned int distributorcode, int codenumber )
...
//  Possible Errors:  NOVXD
//
DWORD __stdcall CAN_SpecialFunktion(unsigned int distributorcode, int codenumber );
...
//  using a RESET
//
//  Possible Errors: ILLCLIENT NOVXD
//
