...
//  ~~~~~~~~~~~~
//
//	- Init(ushort BTR0BTR1, int CANMsgType, int CANHwType, uint IO_Port, ushort Interupt)
//  - Close()  
//  - Status() 
...
public class PCAN_ISA
{
	...
	public const int HW_ISA     = 1;
	public const int HW_ISA_SJA = 9;
	...
	public static extern uint Init(ushort BTR0BTR1, int CANMsgType, int CANHwType, uint IO_Port, ushort Interupt);
