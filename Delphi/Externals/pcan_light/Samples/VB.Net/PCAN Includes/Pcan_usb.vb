...
'  - SetRecvFunc(ByVal hEvent As IntPtr)
'
'  ------------------------------------------------------------------
...
#End Region
        ...
        '  Possible Errors: NOVXD  QRCVEMPTY
        '
        <DllImport("PCAN_USB.dll", EnTryPoint:="CAN_ReadEx")> _
        ...
        '
        <DllImport("PCAN_USB.dll", EntryPoint:="CAN_DLLVersionInfo")> _
        ...
        ' 
        <DllImport("PCAN_USB.dll", EntryPoint:="CAN_ResetClient")> _
        ...
        '
        <DllImport("PCAN_USB.dll", EntryPoint:="CAN_MsgFilter")> _
        ...
        '  Possible Errors: NOVXD
        '
        <DllImport("PCAN_USB.dll", EntryPoint:="CAN_ResetFilter")> _
        ...
        '
        <DllImport("PCAN_USB.dll", EntryPoint:="SetUSBDeviceNr")> _
        ...
        '
        <DllImport("PCAN_USB.dll", EntryPoint:="GetUSBDeviceNr")> _
        ...
        '
        <DllImport("PCAN_USB.dll", EntryPoint:="CAN_SetRcvEvent")> _
