...
Namespace Peak.Can.Light
    Public Class PCAN_ISA

        ' HardwareType
        ' Only SJA 1000 Dongles are supported  !!
        Public Const HW_ISA As Integer = 1
        Public Const HW_ISA_SJA As Integer = 9
...
#End Region
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_Init")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_Close")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_Status")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_Write")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EnTryPoint:="CAN_Read")> _
        ...
        '  Possible Errors: NOVXD  QRCVEMPTY
        '
        <DllImport("PCAN_ISA.dll", EnTryPoint:="CAN_ReadEx")> _
        ...
        '  Possible Errors:  NOVXD
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_VersionInfo")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_DLLVersionInfo")> _
        ...
        ' 
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_ResetClient")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_MsgFilter")> _
        ...
        '  Possible Errors: NOVXD
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_ResetFilter")> _
        ...
        '
        <DllImport("PCAN_ISA.dll", EntryPoint:="CAN_SetRcvEvent")> _
