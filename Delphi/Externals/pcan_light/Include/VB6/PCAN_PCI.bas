...
'
Public Declare Function CAN_Init Lib "pcan_pci" _
...
'
Public Declare Function CAN_Close Lib "pcan_pci" _
    () As Long
...
'
Public Declare Function CAN_Status Lib "pcan_pci" _
    () As Long
...
'
Public Declare Function CAN_Write Lib "pcan_pci" _
...
'
Public Declare Function CAN_Read Lib "pcan_pci" _
    (ByRef msg As TPCANMsg) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_VersionInfo Lib "pcan_pci" _
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_SpecialFunktion Lib "pcan_pci" _
...
'
Public Declare Function CAN_ResetClient Lib "pcan_pci" _
    () As Long
...
'
Public Declare Function CAN_MsgFilter Lib "pcan_pci" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN_ResetFilter Lib "pcan_pci" _
    () As Long
...
'
Public Declare Function CAN_DLLVersionInfo Lib "pcan_pci" _
