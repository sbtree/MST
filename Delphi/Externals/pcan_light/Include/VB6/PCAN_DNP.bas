...
'
Public Declare Function CAN_Init Lib "pcan_dnp" _
...
'
Public Declare Function CAN_Close Lib "pcan_dnp" _
    () As Long
...
'
Public Declare Function CAN_Status Lib "pcan_dnp" _
    () As Long
...
'
Public Declare Function CAN_Write Lib "pcan_dnp" _
...
'
Public Declare Function CAN_Read Lib "pcan_dnp" _
    (ByRef msg As TPCANMsg) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_VersionInfo Lib "pcan_dnp" _
...
'
Public Declare Function CAN_ResetClient Lib "pcan_dnp" _
    () As Long
...
'
Public Declare Function CAN_MsgFilter Lib "pcan_dnp" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN_ResetFilter Lib "pcan_dnp" _
    () As Long
...
'
Public Declare Function CAN_DLLVersionInfo Lib "pcan_dnp" _
    (ByVal buffer As String) As Long