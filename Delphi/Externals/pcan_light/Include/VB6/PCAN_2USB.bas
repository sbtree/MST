...
'  - ResetFilter()
'  - SetUSBDeviceNr(ByVal DevNum As Long)
'  - GetUSBDeviceNr(ByRef DevNum As Long)
'
'  ------------------------------------------------------------------
'  Author : Hoppe, Wilhelm
'  Modified By: Wagner/Wilhelm (20.08.2008)
'
...
'
Public Declare Function CAN2_Init Lib "pcan_2usb" _
...
'
Public Declare Function CAN2_Close Lib "pcan_2usb" _
    () As Long
...
'
Public Declare Function CAN2_Status Lib "pcan_2usb" _
    () As Long
...
'
Public Declare Function CAN2_Write Lib "pcan_2usb" _
...
'
Public Declare Function CAN2_Read Lib "pcan_2usb" _
    (ByRef msg As TPCANMsg) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN2_VersionInfo Lib "pcan_2usb" _
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN2_SpecialFunktion Lib "pcan_2usb" _
    (ByVal distributorcode As Long, ByVal codenumber As Long) As Long
...
'
Public Declare Function CAN2_ResetClient Lib "pcan_2usb" _
    () As Long
...
'
Public Declare Function CAN2_MsgFilter Lib "pcan_2usb" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN2_ResetFilter Lib "pcan_2usb" _
    () As Long
...
'
Public Declare Function SetUSB2DeviceNr Lib "pcan_2usb" _
    (ByVal DevNr As Long) As Long
...
'
Public Declare Function GetUSB2DeviceNr Lib "pcan_2usb" _
    (ByRef DevNr As Long) As Long
...
'
Public Declare Function CAN2_DLLVersionInfo Lib "pcan_2usb" _
