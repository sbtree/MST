...
Public Const HW_ISA As Long = &H1
Public Const HW_ISA_SJA As Long = &H9
...
'
Public Declare Function CAN_Init Lib "pcan_isa" _
...
'
Public Declare Function CAN_Close Lib "pcan_isa" _
    () As Long
...
'
Public Declare Function CAN_Status Lib "pcan_isa" _
    () As Long
...
'
Public Declare Function CAN_Write Lib "pcan_isa" _
...
'
Public Declare Function CAN_Read Lib "pcan_isa" _
    (ByRef msg As TPCANMsg) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_VersionInfo Lib "pcan_isa" _
...
'
Public Declare Function CAN_ResetClient Lib "pcan_isa" _
    () As Long
...
'
Public Declare Function CAN_MsgFilter Lib "pcan_isa" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN_ResetFilter Lib "pcan_isa" _
    () As Long
...
'
Public Declare Function CAN_DLLVersionInfo Lib "pcan_isa" _
    (ByVal buffer As String) As Long