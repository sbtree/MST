...
'  - CAN2_DLLVersionInfo(ByVal buffer As String)
'  - ResetClient()
...
'
Public Declare Function CAN2_Init Lib "pcan_2pci" _
...
'
Public Declare Function CAN2_Close Lib "pcan_2pci" _
    () As Long
...
'
Public Declare Function CAN2_Status Lib "pcan_2pci" _
    () As Long
...
'
Public Declare Function CAN2_Write Lib "pcan_2pci" _
...
'
Public Declare Function CAN2_Read Lib "pcan_2pci" _
    (ByRef msg As TPCANMsg) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN2_VersionInfo Lib "pcan_2pci" _
...
'
Public Declare Function CAN2_DLLVersionInfo Lib "pcan_2pci" _
    (ByVal buffer As String) As Long
...
'
Public Declare Function CAN2_ResetClient Lib "pcan_2pci" _
    () As Long
...
'
Public Declare Function CAN2_MsgFilter Lib "pcan_2pci" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN2_ResetFilter Lib "pcan_2pci" _
    () As Long
