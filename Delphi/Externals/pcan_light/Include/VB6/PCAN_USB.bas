...
Public Type TPCANTimestamp
    ...
    millis_overflow As Long   ' roll-arounds of millis
...
'  Possible Errors: NOVXD  QRCVEMPTY
'
Public Declare Function CAN_ReadEx Lib "PCAN_USB" _
    (ByRef msg As TPCANMsg, ByRef msg As TPCANTimestamp) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_SpecialFunktion Lib "PCAN_USB" _
...
'
Public Declare Function CAN_ResetClient Lib "PCAN_USB" _
         () As Long
...
'
Public Declare Function CAN_MsgFilter Lib "PCAN_USB" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN_ResetFilter Lib "PCAN_USB" _
       () As Long
...
'
Public Declare Function SetUSBDeviceNr Lib "PCAN_USB" _
    (ByVal DevNum As Long) As Long
...
'
Public Declare Function GetUSBDeviceNr Lib "PCAN_USB" _
    (ByRef DevNum As Long) As Long
...
'
Public Declare Function CAN_DLLVersionInfo Lib "pcan_usb" _
    (ByVal buffer As String) As Long
...
'
Public Declare Function CAN_SetRcvEvent Lib "pcan_usb" _
