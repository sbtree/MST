...
'  - SpecialFunktion(ByVal distributorcode As Long, ByVal codenumber As Long)
'  - ResetClient()
...
'
Public Declare Function CAN_Init Lib "pcan_pcc" _
...
'
Public Declare Function CAN_Close Lib "pcan_pcc" _
    () As Long
...
'
Public Declare Function CAN_Status Lib "pcan_pcc" _
    () As Long
...
'
Public Declare Function CAN_Write Lib "pcan_pcc" _
...
'
Public Declare Function CAN_Read Lib "pcan_pcc" _
    (ByRef msg As TPCANMsg) As Long
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_VersionInfo Lib "pcan_pcc" _
...
'  Possible Errors:  NOVXD
'
Public Declare Function CAN_SpecialFunktion Lib "pcan_pcc" _
    (ByVal distributorcode As Long, _
    ByVal codenumber As Long) As Integer
...
'
Public Declare Function CAN_ResetClient Lib "pcan_pcc" _
    () As Long
...
'
Public Declare Function CAN_MsgFilter Lib "pcan_pcc" _
...
'  Possible Errors: NOVXD
'
Public Declare Function CAN_ResetFilter Lib "pcan_pcc" _
    () As Long
...
'
Public Declare Function CAN_DLLVersionInfo Lib "pcan_pcc" _
    (ByVal buffer As String) As Long