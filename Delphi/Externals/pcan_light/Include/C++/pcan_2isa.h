...
//  ~~~~~~~~~~~~
//
//  - CAN2_Init(WORD wBTR0BTR1, int CANMsgType, int CANHwType, DWORD IO_Port, WORD Interupt)
//  - CAN2_Close(void)  
//  - CAN2_Status(void) 
//  - CAN2_Write(TPCANMsg* pMsgBuff) 
//  - CAN2_Read(TPCANMsg* pMsgBuff)  
//  - CAN2_ReadEx(TPCANMsg* pMsgBuff, TPCANTimestamp*  pRcvTime)
//  - CAN2_VersionInfo(LPSTR lpszTextBuff) 
//  - CAN2_DLLVersionInfo(LPSTR lpszTextBuff) 
//  - CAN2_MsgFilter(DWORD FromID,DWORD ToID, int Type) 
//  - CAN2_ResetFilter(void) 
//  - CAN2_ResetClient(void) 
//  - CAN2_SetRcvEvent(HANDLE hEvent)
//
//  ------------------------------------------------------------------
...
//
#ifndef __PCAN2ISAH__        
#define __PCAN2ISAH__
...
//
DWORD __stdcall CAN2_Init(WORD wBTR0BTR1, int CANMsgType, int CANHwType, DWORD IO_Port, WORD Interupt);        
...
//  Possible Errors: NOVXD  QRCVEMPTY
//
DWORD __stdcall CAN2_ReadEx(TPCANMsg* pMsgBuff, TPCANTimestamp*  pRcvTime);      
...
//
DWORD __stdcall CAN2_DLLVersionInfo(LPSTR lpszTextBuff);
...
//
DWORD __stdcall CAN2_SetRcvEvent(HANDLE hEvent);
