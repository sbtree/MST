...
'  ~~~~~~~~~~~~
'
'  - Init(ByVal BTR0BTR1 As Short, ByVal CANMsgtype As Integer)
'  - Close()  
'  - Status() 
...
'  - ResetFilter()
'  - SetUSBDeviceNr(ByVal DevNum As Integer)
'  - GetUSBDeviceNr(ByRef DevNum As Integer)
'  - SetRcvEvent(ByVal hEvent As IntPtr)
'
'  ------------------------------------------------------------------
'  Author : Hoppe, Wilhelm
'  Modified By: Wagner/Wilhelm (28.09.2009)
'
...
#End Region
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_Init")> _
        Public Shared Function Init(ByVal BTR0BTR1 As Short, ByVal CANMsgtype As Integer) As Integer
        End Function
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_Close")> _
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_Status")> _
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_Write")> _
        ...
        '
        <DllImport("PCAN_2USB.dll", EnTryPoint:="CAN2_Read")> _
        ...
        '  Possible Errors: NOVXD  QRCVEMPTY
        '
        <DllImport("PCAN_2USB.dll", EnTryPoint:="CAN2_ReadEx")> _
        ...
        '  Possible Errors:  NOVXD
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_VersionInfo")> _
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_DLLVersionInfo")> _
        ...
        '  Possible Errors:  NOVXD
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_SpecialFunktion")> _
        ...
        ' 
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_ResetClient")> _
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_MsgFilter")> _
        ...
        '  Possible Errors: NOVXD
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_ResetFilter")> _
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="SetUSB2DeviceNr")> _
        Public Shared Function SetUSBDeviceNr(ByVal DevNum As Integer) As Integer
        End Function
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="GetUSB2DeviceNr")> _
        Public Shared Function GetUSBDeviceNr(ByRef DevNum As Integer) As Integer
        End Function
        ...
        '
        <DllImport("PCAN_2USB.dll", EntryPoint:="CAN2_SetRcvEvent")> _
