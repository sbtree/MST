...
#End Region
        ...
        '  Possible Errors: NOVXD  QRCVEMPTY
        '
        <DllImport("PCAN_PCI.dll", EnTryPoint:="CAN_ReadEx")> _
        ...
        '
        <DllImport("PCAN_PCI.dll", EntryPoint:="CAN_DLLVersionInfo")> _
        ...
        '
        <DllImport("PCAN_PCI.dll", EntryPoint:="CAN_SetRcvEvent")> _
