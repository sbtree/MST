...
//  ~~~~~~~~~~~~
//
//  - CAN_Init(wBTR0BTR1: Word; CANMsgType: Integer; CANHwType: Integer; IO_Port: LongWord; Interupt: Word)
//  - CAN_Close()
//  - CAN_Status()
//  - CAN_Write(var MsgBuff: TPCANMsg)
//  - CAN_Read(var MsgBuff: TPCANMsg)
//  - CAN_ReadEx(var MsgBuff: TPCANMsg; var RcvTime: TPCANTimestamp)
//  - CAN_VersionInfo(lpszTextBuff: PAnsiChar)
//  - CAN_DLLVersionInfo(lpszTextBuff: PAnsiChar)
//  - CAN_ResetClient()
...
const DLL_Name = 'PCAN_DNP.dll';

function CAN_Init(wBTR0BTR1: Word; CANMsgType: Integer; CANHwType: Integer; IO_Port: LongWord;
          Interupt: Word): LongWord; stdcall;
external DLL_Name;
