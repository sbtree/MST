		...
		namespace Light
		{
			public ref class PCAN_PCI
			{
				public:
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_Init")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_Close")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_Status")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_Write")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_Read")]
					...
					//  Possible Errors: NOVXD  QRCVEMPTY
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_ReadEx")]
					...
					//  Possible Errors:  NOVXD
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_VersionInfo")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint="CAN_DLLVersionInfo")]
					...
					//  Possible Errors:  NOVXD
					//
					[DllImport("PCAN_PCI.dll", EntryPoint = "CAN_SpecialFunktion")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint = "CAN_ResetClient")]
					...
					//
					[DllImport("PCAN_PCI.dll", EntryPoint = "CAN_MsgFilter")]
					...
					//  Possible Errors: NOVXD
					//
					[DllImport("PCAN_PCI.dll", EntryPoint = "CAN_ResetFilter")]
					...
					//
					[DllImport("PCAN_PCI.DLL", EntryPoint="CAN_SetRcvEvent")]
