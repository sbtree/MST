		...
		namespace Light
		{
			public ref class PCAN_2PCI
			{
				public:
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_Init")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_Close")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_Status")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_Write")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_Read")]
					...
					//  Possible Errors: NOVXD  QRCVEMPTY
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_ReadEx")]
					...
					//  Possible Errors:  NOVXD
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_VersionInfo")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint="CAN2_DLLVersionInfo")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint = "CAN2_ResetClient")]
					...
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint = "CAN2_MsgFilter")]
					...
					//  Possible Errors: NOVXD
					//
					[DllImport("PCAN_2PCI.dll", EntryPoint = "CAN2_ResetFilter")]
					...
					[DllImport("PCAN_2PCI.DLL", EntryPoint="CAN2_SetRcvEvent")]
