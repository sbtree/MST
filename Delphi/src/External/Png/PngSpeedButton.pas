...
type
  ...
  published
    ...
    // 2015-11-19 /gsv/: Glyph und NumGlyphs in der dfm-Datei speicherbar (Begründung s. Loaded) (stored false entfernt)
    property Glyph;
    property NumGlyphs;
  end;
...
begin
  ...
  // Andernfalls hat das PngImage höhere Prio!
  ...
  begin
    // Glyph nicht gesetzt bzw. PngImage gesetzt ==> PngImage übernehmen
    CreatePngGlyph();
  end;   
end;
