...
begin
  result := '';
  if IsPCanMsg(ba_rbuf, w_rlen) then begin
    p_pcanmsg := PPCANMsg(@ba_rbuf);
...
begin
  ...
  //It is possible to receive no data if the data is already received by event-function
  result := (w_rlen > 0);
end;
